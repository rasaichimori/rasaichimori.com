			...
			if(TLleft<elements.timeline.offsetWidth-600){
				...
				if(PTLevent!=TLevent){
					...
					if(TLevent == 1){
						locName = "Fukuoka";
						locRotation = 2.4;
						elements.timelineText.innerHTML = "I was born in a city in Japan called Fukuoka. I have been back many times to visit my extended family. Its a great place! For the food alone, 10/10 would recommend.";
					}
					if(TLevent == 2){
						locName = "Edinburgh";
						locRotation = 4.7;
						elements.timelineText.innerHTML = "Then we moved to Edinburgh! I don't remember much, but my parents did love it here. Apparently, I was given money by complete strangers all the time!  (I wish that still happened)<br><br>My parents' schooling and work will take us all over the place as you'll see...";
					}
					if(TLevent == 3){
						locName = "Singapore";
						locRotation = 2.5;
					...
					if(TLevent == 4){
						locName = "Utah";
						locRotation = 0.2;
						elements.timelineText.innerHTML = "After moving to America, I was acing every test! The school was actually starting to become fun! <br><br>I was (and still am) what is known as a nerd.🙂";
					}
					if(TLevent == 5){
						locName = "Utah";
						locRotation = 0.2;
						elements.timelineText.innerHTML = "I entered my first robotics compeition called the First® Lego League at 12 years old, and man, it was fun. I was working with a team of my friends and we placed 4th place in the regional competition.<br><br>Not much, but we were overjoyed!";
					}
					if(TLevent == 6){
						locName = "Utah";
						locRotation = 0.2;
					...
					if(TLevent == 8){
						locName = "Utah";
						locRotation = 0.2;
						elements.timelineText.innerHTML = "I graduated at highschool 16.  And to be completely honest, I wish didn't rush so much. Sixteen is a little to early to be living alone. After a year, I felt I needed a break.";
					}
					if(TLevent == 9){
						locName = "Sendai";
						locRotation = 2.2;
						elements.timelineText.innerHTML = "I decided a wanted to go on a two year volunteer service opportunity for my church. I went to the Tohoku area, a place I'd never been before. It was the most fun I've ever had in my life. I met so many wonderful people.";
					}
					if(TLevent == 10){
						locName = "Utah";
						locRotation = 0.2;
